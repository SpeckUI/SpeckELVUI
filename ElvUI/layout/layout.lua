...
function LO:CreateChatPanels()
	...
	lchattab:SetTemplate('Transparent', true)
	...
	lchatdp:SetTemplate('Transparent', true)
	...
	lchattb:SetTemplate('Transparent', true)
	...
	rchattab:SetTemplate('Transparent', true)
	...
	rchatdp:SetTemplate('Transparent', true)
	...
	rchattb:SetTemplate('Transparent', true)
